...
// let a = [12,42,42,12,5,3,45,644,23,85];
// let maxNumber = array => console.log(Math.max.apply(null,array));
// maxNumber(a);
// - створити функцію яка повертає найменьше число з масиву
// let a = [12,42,42,12,5,3,45,644,23,85];
// let maxNumber = array => console.log(Math.min.apply(null,array));
// maxNumber(a);
//
...
// let randomNumber = (array, count,d) => {
//     for (let i = 0; i < count; i++) {
...
// let arrayRevers = array => array.reverse();
